...
type Props = {
  ...
  tripId: string;
  onClose: () => void;
  onAdd: (stop: StopInsert) => Promise<unknown>;
};

export function AddStopModal({ visible, tripId, onClose, onAdd }: Props) {
  ...
  }, [name, location, category, notes, date, tripId, onAdd, reset, onClose]);
